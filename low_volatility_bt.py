...
import time
BASE = Path(os.getcwd())
TOP20_DIR = BASE / "Top 20 low volatility 40 days stock"
DAYWISE_DIR = BASE / "daywise stocks"
OUTPUT_FILE = BASE / "NIFTY_LargeMidcap_250_lowvol_40_days_tracker.xlsx"
...
top20_files = sorted(TOP20_DIR.glob("top20_low_vol_*.csv"))
rebalance_dates = []
rebalance_data = {}
...
if not daily_df.empty:
    ...
    labels_vals = [
        ("Strategy", "Low Volatility Top 20, No Stop-Loss"),
