...
import time
BASE = Path(os.getcwd())
TOP20_DIR = BASE / "Top 20 NSE Low Volatility"
DAYWISE_DIR = BASE / "daywise stocks"
OUTPUT_FILE = BASE / "NIFTY_LargeMidcap_250_NSE_lowvol_tracker.xlsx"
...
for index, rebalance_date in enumerate(rebalance_dates):
    ...
    vol_lookup = dict(zip(top20_df["Symbol"].str.strip(), top20_df["AnnualVolatility"]))
